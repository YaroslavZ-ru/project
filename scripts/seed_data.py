...
CONCEPTS_DATA = [
    {
        ...
        'parameters': [
            {'name': 'size_mm',     'label_ru': 'Размер',    'type': 'float',  'description': 'Под ключа в мм', 'unit': 'мм'},
            {'name': 'material',   'label_ru': 'Материал',  'type': 'string', 'description': 'Материал изготовления'},
            {'name': 'torque_nm',  'label_ru': 'Момент затяжки', 'type': 'float',  'description': 'Максимальный момент', 'unit': 'Н·м'},
        ],
    },
    {
        'id': 'concept_002',
        ...
        'domain': 'слесарный инструмент',
        'parameters': [
            {'name': 'size_range_mm', 'label_ru': 'Диапазон размеров', 'type': 'string', 'description': 'Мин-макс размер в мм'},
            {'name': 'material',      'label_ru': 'Материал',          'type': 'string', 'description': 'Материал изготовления'},
        ],
    },
    {
        ...
        'domain': 'музыка',
        'parameters': [
            {'name': 'clef_type',      'label_ru': 'Тип ключа',   'type': 'enum',    'description': 'Вид музыкального ключа', 'enum_values': '["\u0441\u043a\u0440\u0438\u043f\u0438\u0447\u043d\u044b\u0439","\u0431\u0430\u0441\u043e\u0432\u044b\u0439","\u0430\u043b\u044c\u0442\u043e\u0432\u044b\u0439"]'},
            {'name': 'staff_position', 'label_ru': 'Позиция на нотном стане', 'type': 'integer', 'description': 'Номер линии'},
        ],
    },
]
